package com.example.lyl.myapplication.socketclient;
	...
	private class MyReceiverRunnable implements Runnable {
		...
		public void run() {
			...
			while (true) {
				...
				//boolean isc=mSocket.isClosed();
				if (isConnected) {


					if (mSocket != null && mSocket.isConnected()) {
						Log.i(tag, "---->>client mSocket..."+mSocket.isClosed());
						...
						Log.i(tag, "---->>client mSocket....isClosed");
					}
				}else{
					Log.i(tag, "---->>client mSocket....isClosed");
				}
